...
This directory builds `dist/turborec_3.0.0_all.deb`.
...
3. Emits `dist/turborec_3.0.0_all.deb`.
...
ar t dist/turborec_3.0.0_all.deb
mkdir -p /tmp/deb && ar x dist/turborec_3.0.0_all.deb --output /tmp/deb
